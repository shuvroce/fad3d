...
OUT_SUMMARY_PDF = os.path.join(BASE_DIR, "summary.pdf")
TEMPLATE_DIR = os.path.join(BASE_DIR, "templates")
REPORT_TEMPLATE_DIR = os.path.join(BASE_DIR, "templates", "report")
...
CSS_PATH = os.path.join(REPORT_TEMPLATE_DIR, "assets", "css", "report.css")
